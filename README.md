...
manuf.py fully supports even more esoteric entries in the database. For
example, consider these two entries:
...
Although optimized for correctness, manuf.py is also quite fast.
...
To look up "00:1B:C5:00:0F:FF" we will check the dict beginning with a "bits
...
Since (12, 0x001BC5000FFF >> 12) equals our key of (12, 0x001BC5000000 >> 12),
we have a match on the 13th iteration of the loop.
